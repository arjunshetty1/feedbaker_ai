          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                <h1 className="text-xl font-bold text-gray-800">Feedbaker AI</h1>
              </div>
          ...
          <div className="mt-10">
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 mb-6">
              ...
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md ${
                  activeTab === "saloon" ? "bg-blue-500 text-white" : "bg-white text-gray-700 hover:bg-gray-100"
                }`}
              >
                Saloon
              </button>
...
{activeTab === "saloon" && (
      ...
      <div id="pricing" className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8">
            {/* Basic Plan */}
  ...
  <div className="max-w-7xl mx-auto py-12 px-6 lg:px-8">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      <div>
        <h3 className="text-xl font-bold text-gray-900 mb-4">FeedbackAI</h3>
        <p className="text-base text-gray-600 mb-6">AI-powered actionable feedback platform that helps businesses improve customer experience.</p>
      </div>
      ...
      <div>
        ...
        <p className="text-base text-gray-600 mb-2">
          <span className="font-medium">Email:</span> contact@feedbakerai.com
        </p>
        <p className="text-base text-gray-600 mb-2">
          <span className="font-medium">Phone:</span> +91 7892828917
        </p>
    ...
    <div className="mt-12 pt-8 border-t border-gray-200">
      <p className="text-center text-base text-gray-600">© 2025 FeedbackAI. All rights reserved.</p>
    </div>
  </div>
</footer>
    </div>
